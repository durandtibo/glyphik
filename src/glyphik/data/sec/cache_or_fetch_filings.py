r"""Provide cache-or-fetch utilities for SEC filings."""
...
def load_or_fetch_filings(
    ...
    Args:
        companies: The list of
            :class:`~glyphik.data.sp1500.CompanyIdentifier` instances
            to fetch filings for.
    ...
    Returns:
        ...
        instances across all companies.  Companies for which fetching
        failed contribute no records.
    """
...
def load_or_fetch_company_filings(
    company: CompanyIdentifier, config: Config, output_dir: Path
) -> list[SecFilingRecord]:
    ...
    Args:
        company: The :class:`~glyphik.data.sp1500.CompanyIdentifier`
            to fetch filings for.
    ...
    Returns:
        ...
        for this company.  Empty if fetching failed.
    """
