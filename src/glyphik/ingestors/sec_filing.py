...
class SecFilingIngestor(BaseIngestor[list[SecFilingRecord]], MultilineDisplayMixin):
    ...
    Example:
        ...
        >>> from glyphik.ingestors import SecFilingIngestor, Sp1500CompanyIngestor
        >>> ingestor = SecFilingIngestor(
        ...     company_ingestor=InMemoryIngestor([CompanyIdentifier(cik=320193, ticker="AAPL")]),
        ...     output_dir=Path("sec"),
    ...
    def __init__(
        self,
        company_ingestor: BaseIngestor[list[CompanyIdentifier]],
        output_dir: Path | str,
        start_date: date,
        end_date: date,
        forms: Sequence[str],
