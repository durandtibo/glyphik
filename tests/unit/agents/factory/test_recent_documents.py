...
def _inner_agent_factory() -> AgentFactory:
...
def test_recent_documents_agent_factory_stores_inner_agent_factory() -> None:
    inner_agent_factory = _inner_agent_factory()
    factory = RecentDocumentsAgentFactory(inner_agent_factory=inner_agent_factory)
    assert factory._inner_agent_factory is inner_agent_factory


def test_recent_documents_agent_factory_default_max_documents() -> None:
    factory = RecentDocumentsAgentFactory(inner_agent_factory=_inner_agent_factory())
...
def test_recent_documents_agent_factory_stores_max_documents() -> None:
    factory = RecentDocumentsAgentFactory(
        inner_agent_factory=_inner_agent_factory(), max_documents=3
    )
...
def test_recent_documents_agent_factory_make_agent_uses_inner_agent_factory() -> None:
    ...
    factory = RecentDocumentsAgentFactory(inner_agent_factory=_StubAgentFactory())
    agent = factory.make_agent()
